...
```
```{r, echo=F}
plot_temp(file = nc_file, fig_path = '../images_temperature.png')
```
```{r, eval=F}
plot_temp(file = nc_file, fig_path = FALSE)
```
<img src="../images_temperature.png" alt="lake temperature" align="center" style="width: 90%;"/>
...
```
```{r, echo=F}
plot_temp(file = nc_file, fig_path = '../images_temperature2.png')
```
```{r, eval=F}
plot_temp(file = nc_file, fig_path = FALSE)
```
<img src="../images_temperature2.png" alt="lake temperature" align="center" style="width: 90%;"/>
