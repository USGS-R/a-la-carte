...
##NHD+
NHDPlus is an integrated suite of application-ready geospatial data sets that incorporate many of the best features of the National Hydrography Dataset (NHD), the National Elevation Dataset (NED), and the Watershed Boundary Dataset (WBD).USGS and EPA contract Horizon Systems to build and maintain [NHD+](http://www.horizon-systems.com/nhdplus/). The NHD+ V2 is available for 1:100,000 NHD; high-res NHD+ in development. 
...
4. and much more, including value-added spinoff products such as [StreamCat](https://www.epa.gov/national-aquatic-resource-surveys/streamcat)
