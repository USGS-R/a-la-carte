...
<img src="images/geoknife.png" alt="geoknife" style="width: 200px;"/>
...
geoknife: 1) allows the user to avoid downloading large datasets, 2) avoids reinventing the wheel for the creation and optimization of complex geoprocessing algorithms, and 3) uses computing resources that are dedicated elsewhere, so geoknife operations do not have much of an impact on a local computer.
