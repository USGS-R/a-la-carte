...
```
* from `sp::SpatialPolygons` class from a local shapefile
This is a hack right now, so I am not going to show it. But suggest it [here](https://github.com/USGS-R/geoknife/issues) if you want it.
...
## Stencil
all things that can be coerced into a `simplegeom` or `webgeom` can 
